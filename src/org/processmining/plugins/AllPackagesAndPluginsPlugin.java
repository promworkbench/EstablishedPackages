...
@Plugin(name = "Show All Package and All Plug-ins", parameterLabels = {}, returnLabels = { "Release info" }, returnTypes = { HTMLToString.class }, userAccessible = true)
public class AllPackagesAndPluginsPlugin implements HTMLToString {

	private Collection<PluginDescriptor> pluginDescriptors;

	private AllPackagesAndPluginsPlugin(UIPluginContext context) {
	...
	public static HTMLToString info(final UIPluginContext context) {
		return new AllPackagesAndPluginsPlugin(context);
	}
